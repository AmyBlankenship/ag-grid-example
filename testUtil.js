const ensureGridApiHasBeenSet = component => new Promise(function (resolve, reject) {
...
export const waitForAgGridReady = (grid, done) => {
  ensureGridApiHasBeenSet(grid).then(done)
}